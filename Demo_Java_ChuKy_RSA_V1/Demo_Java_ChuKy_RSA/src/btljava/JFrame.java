...
public class JFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnThoat1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/btljava/logout.png"))); // NOI18N
        ...
        jLabel44.setText("Tài liệu liệu tham khảo và hướng dẫn: https://drive.google.com/drive/folders/11APyCzHjjv823LUjLMNyOd-NmeX62-hE");
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jLabel44, javax.swing.GroupLayout.PREFERRED_SIZE, 848, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addGap(201, 201, 201)
...
//xác nhận chữ kí
    ...
    private void btnXacNhanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXacNhanActionPerformed
        // TODO add your handling code here:
        if (evt.getSource() == btnXacNhan) { // Kiểm tra xem sự kiện có được kích hoạt bởi nút btnXacNhan không.
            ...
            // Đọc văn bản từ trường txtVanBanCanXacNhan
            ...
            try {
                while ((line = bufferedReader.readLine()) != null) {
                    builder.append(line);
                    builder.append(System.lineSeparator());//thêm 1 dòng trống
                }
                text = builder.toString();
                // Đọc từng dòng văn bản và thêm vào StringBuilder, sau đó chuyển sang chuỗi.

                String bam;
                try {
                    bam = SHA1.hash(text);
                    // Sử dụng thuật toán SHA-1 để băm văn bản cần xác nhận.
                    ...
                    try {
                        ...
                        // Khởi tạo đối tượng RSA và chuỗi chữ ký để giải mã.

                        String giaima = rsa.decrypt(sign, a, b);
                        // Giải mã chuỗi chữ ký.
                        ...
                        JOptionPane.showMessageDialog(null, "Chữ ký hoặc khóa ngoài không hợp lệ!",
                                "Thông báo", JOptionPane.ERROR_MESSAGE);
                    }
                } catch (NoSuchAlgorithmException ex) {
                    // Bắt ngoại lệ nếu thuật toán băm không tồn tại.
                    Logger.getLogger(JFrame.class.getName()).log(Level.SEVERE, null, ex);
                }

            } catch (IOException e) {
                // Bắt ngoại lệ nếu có lỗi đọc file.
                e.printStackTrace();
            }
        }
    ...
    private void btnTaiChuKyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTaiChuKyActionPerformed
        ...
        if (evt.getSource() == btnTaiChuKy) {
            JFileChooser fileChooser = new JFileChooser();// Tạo một đối tượng JFileChooser để chọn file.
            FileNameExtensionFilter filter = new FileNameExtensionFilter("Text Files", "txt");
            // Tạo một bộ lọc để chỉ hiển thị các file có phần mở rộng là "txt".
            fileChooser.setFileFilter(filter);
            int returnValue = fileChooser.showOpenDialog(null);
            // Biến returnValue lưu giữ sự chọn của người dùng (APPROVE_OPTION, CANCEL_OPTION, v.v.).
            if (returnValue == JFileChooser.APPROVE_OPTION) {
                String fileName = fileChooser.getSelectedFile().getAbsolutePath();
                // Lấy đường dẫn tuyệt đối của file đã chọn.
                try (BufferedReader reader = new BufferedReader(new FileReader(fileName))) {
                    // Tạo một BufferedReader để đọc nội dung của file đã chọn.
                    String line;
                    line = reader.readLine();  // Đọc dòng đầu tiên từ file.
    ...
    private void btnTaiVanBan2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTaiVanBan2ActionPerformed
        ...
        if (evt.getSource() == btnTaiVanBan2) {
            // Tạo một thể hiện mới của JFileChooser, một thành phần Swing để chọn file.
            JFileChooser fileChooser = new JFileChooser();
            int result = fileChooser.showOpenDialog(null); 
            if (result == JFileChooser.APPROVE_OPTION) {// Nếu người dùng chọn mở một file (nhấn "Open" hoặc tương tự),
                File selectedFile = fileChooser.getSelectedFile();// Lấy file đã chọn từ JFileChooser.
                try {
                    BufferedReader reader = new BufferedReader(new FileReader(selectedFile));
                    // Tạo một BufferedReader để đọc nội dung của file đã chọn.
                    String line;
                    StringBuilder content = new StringBuilder();
                    // Đọc từng dòng từ file và nối vào StringBuilder
